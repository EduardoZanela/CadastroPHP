...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="../controller/logingController.php?operation=validar" method="post">
        <h2 class="form-signin-heading" style="text-align: center;">Sistema Motel Brazileirinhas</h2>
        <h2 class="form-signin-heading" style="text-align: center;">Login here</h2>
